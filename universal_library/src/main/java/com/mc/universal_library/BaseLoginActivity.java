package com.mc.universal_library;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_login.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(BaseLoginActivity.this,"登录成功", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(BaseLoginActivity.this,"用户名或密码错误，请重新登录", Toast.LENGTH_LONG).show();
                }
